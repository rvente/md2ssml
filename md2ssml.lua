...
local function break_strength(strength)
...
function SoftBreak()
  return break_strength("medium")
end

function LineBreak()
  return break_strength("weak")
end

function Emph(s)
  return '<emphasis level="weak">' .. s .. "</emphasis>"
end

function Strong(s)
  return '<emphasis level="strong">' .. s .. '</emphasis>'
end

function Subscript(s)
  return describe_markup("subscript", s)
end

function Superscript(s)
  return describe_markup("superscript", s)
end
...
function Strikeout(s)
  return describe_markup('strikeout', s)
end
...
function Div(s, attr)
  return Sentence(s..attributes(attr))
end
...
function Header(lev, s, attr)
  return Sentence(
    Emph("Header " .. lev .. " " .. attributes(attr) ..  s)
...
function CodeBlock(s, attr)
  ...
  return describe_markup("code", s) .. attributes(attr)
end
